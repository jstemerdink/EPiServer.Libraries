...
**This will be the last version in this branch. I have moved the provider to a sperate project by request. 
It will be using a different base provider and also a new namespace by request of EPiServer. It is located overhere: [A custom localization provider (new version)](https://github.com/jstemerdink/EPi.Libraries.Localization)**
